  ...
  if (page === "privacy") {
    return (
      <Page title="Politique de confidentialité">
        ...
        <p>Hébergement des données et authentification : Supabase. Génération de texte : Anthropic. Génération d'images et de vidéos : PiAPI (modèles ByteDance Seedance et Seedream). Voix et transcription : ElevenLabs. Paiement : Stripe. E-mails : Resend. Publication sur les réseaux (si activée) : Zernio, qui conserve les autorisations d'accès aux comptes que vous connectez et que vous pouvez révoquer à tout moment depuis Viralya. Certains prestataires sont situés hors de l'Union européenne ; les transferts s'appuient sur leurs clauses contractuelles types. Les textes, images et voix envoyés à ces prestataires servent uniquement à produire les contenus demandés.</p>
